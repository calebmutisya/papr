...
function TopCard() {
  return (
    <Link href='#'>
      <div className='articlecard min-w-[300px] max-w-[540px]'>
        ...
        <div>
          <h1 className='font-[600] line-clamp-[2] mb-[15px] underline-lines '>VR Is the Use of Computer Technology to Create a Simulated Environment.</h1>
